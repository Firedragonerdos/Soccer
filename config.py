...
BALL_RADIUS = 0.11
BALL_MASS = 0.43
BALL_BOUNCE_COEFFICIENT = 0.65
BALL_FRICTION_GROUND = 0.985
BALL_FRICTION_AIR = 0.998
BALL_GRAVITY = -9.81
BALL_MAX_SPEED = 45.0
BALL_SPIN_DECAY = 0.97
BALL_SPIN_EFFECT = 0.15
BALL_ROLL_FRICTION = 0.975
BALL_BOUNCE_MIN_VELOCITY = 0.3
...
# Passing
PASS_SHORT_POWER = 12.0
PASS_MEDIUM_POWER = 18.0
PASS_LONG_POWER = 25.0
PASS_THROUGH_BALL_POWER = 20.0
PASS_LOB_POWER = 15.0
PASS_LOB_ANGLE = math.radians(35)
PASS_ACCURACY_BASE = 0.92
PASS_POWER_CHARGE_RATE = 25.0
PASS_MAX_POWER = 35.0
PASS_CROSS_POWER = 22.0
